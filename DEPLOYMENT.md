...
## Overview
This guide explains how to deploy the Python FastAPI backend to Firebase App Hosting (Cloud Run).
...
# Deploy functions (backend) - this will use the Dockerfile
...
This error occurs when Firebase tries to run a Node.js application instead of Python. The Dockerfile we created fixes this by:
1. Using a Python base image
2. Installing Python dependencies
3. Running `python main.py` instead of Node.js
...
The application will listen on port 8080 (or the PORT environment variable) and handle requests through the FastAPI framework.
