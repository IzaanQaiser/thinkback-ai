        ...
        <div className="flex-1 p-5 flex flex-col">
          <div className="flex items-start space-x-4 h-full">
            <div className="flex-grow flex flex-col flex-1 min-h-0 h-full">
              ...
              {/* Display channel name for YouTube videos, TikTok videos, X posts, and Instagram posts */}
              {platform && ((platform.toLowerCase().includes('youtube') || platform.toLowerCase().includes('video')) || platform.toLowerCase().includes('tiktok') || platform.toLowerCase().includes('twitter') || platform.toLowerCase().includes('x') || platform.toLowerCase().includes('instagram')) && channel && (
